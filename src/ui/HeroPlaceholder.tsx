			...
			<div className="relative isolate">
				<div className="mx-auto max-w-2xl py-4 sm:py-6 lg:py-8">
					<div className="flex flex-col items-center text-center">
						...
						<p className="mt-6 text-base leading-6 text-stone-600"></p>
						<p className="text-base leading-6 text-stone-600">
							A curated collection of resources dedicated to fostering diversity and inclusion in the tech
							industry, highlighting conferences and events committed to making a positive impact.
						</p>
					</div>
				</div>
			</div>
